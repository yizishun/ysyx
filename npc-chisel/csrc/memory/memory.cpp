...
static const uint32_t img[] = {
    ...
    0b00000000001000110000010100110011, // add x10, x6, x2 (x10 = x6 + x2 = 8)       0x80000028
    0b00000000001101000000010110110011, // add x11, x8, x3 (x11 = x8 + x3 = 5)       0x8000002C
    0b10100000000000000000011000110111, // lui  x12, 0xA0000 (x12 = 0xA0000000)      0x80000030
    0b00000000000101100000000000100011, // sb   x1, 0(x12) (store x1 to 0xA0000000)  0x80000034
    0b00000000000001100000011010000011, // lb   x13, 0(x12) (load from 0xA0000000 to x13) 0x80000038
    0b00000000000100000000000001110011  // ebreak                                    0x8000003C
};
