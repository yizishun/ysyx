...
static const uint32_t img[] = {
   ...
   //0b00000001000000000000000001101111, // jal x0, 0x30000028 (jump to 0x30000028)   0x30000018
    ...
    // Add 4 'add a0, a0, a1' instructions here
    0b00000000101101010000010100110011, // add x10, x10, x11 (add a0, a0, a1)       0x30000030
	0b00000000101101010000010100110011,
    0b00000000101101010000010100110011, // add x10, x10, x11 (add a0, a0, a1)       0x30000034
    0b00000000101101010000010100110011, // add x10, x10, x11 (add a0, a0, a1)       0x30000038
    0b00000000101101010000010100110011, // add x10, x10, x11 (add a0, a0, a1)       0x3000003C

    0b00000000000100000000000001110011  // ebreak                                  0x30000040
};
